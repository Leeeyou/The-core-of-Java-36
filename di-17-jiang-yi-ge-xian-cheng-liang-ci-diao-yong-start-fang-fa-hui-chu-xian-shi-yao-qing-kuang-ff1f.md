...
再有就是慎用ThreadLocal，参看[leeeyou ](http://leeeyou.xyz/2017/04/14/blog-2017-04-14-Java之基础知识汇总/#ThreadLocal的设计理念与作用)，这是 Java 提供的一种保存线程私有信息的机制，因为其在整个线程生命周期内有效，所以可以方便地在一个线程关联的不同业务模块之间传递信息，比如事务 ID、Cookie 等上下文相关信息。
